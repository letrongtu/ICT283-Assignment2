...
public:
    ...
    using outputFunction = void (*)(const T& data, Vector<double>& vector);
     ...
     *  @return void
    */
    void inOrder(const outputFunction f, Vector<double>& vector) const;

    /** @brief Pre-order traversal of the BST.
     *  @param f Function pointer to be called on each node's data.
     *  @return void
    */
    void preOrder(const outputFunction f, Vector<double>& vector) const;

    /** @brief Post-order traversal of the BST.
     *  @param f Function pointer to be called on each node's data.
     *  @return void
    */
    void postOrder(const outputFunction f, Vector<double>& vector) const;
...
private:
     ...
     * @return void
     */
    void inOrderHelper(const Node<T>* node,  const outputFunction f, Vector<double>& vector) const;
     ...
     * @return void
     */
    void preOrderHelper(const Node<T>* node, const outputFunction f, Vector<double>& vector) const;
     ...
     * @return void
     */
    void postOrderHelper(const Node<T>* node, const outputFunction f, Vector<double>& vector) const;
};
...
template <class T>
void BST<T>::inOrder(const outputFunction f, Vector<double>& vector) const{
    inOrderHelper(this->root, f, vector);
}
...
template <class T>
void BST<T>::inOrderHelper(const Node<T>* node, const outputFunction f, Vector<double>& vector) const{
    if(node != nullptr){
        inOrderHelper(node->left, f, vector);
        f(node->data, vector);
        inOrderHelper(node->right, f, vector);
    }
}
...
template <class T>
void BST<T>::preOrder(const outputFunction f, Vector<double>& vector) const{
    preOrderHelper(this->root, f, vector);
}
...
template <class T>
void BST<T>::preOrderHelper(const Node<T>* node, const outputFunction f, Vector<double>& vector) const{
     if(node != nullptr){
        f(node->data, vector);
        preOrderHelper(node->left, f, vector);
        preOrderHelper(node->right, f, vector);
    }
}
...
template <class T>
void BST<T>::postOrder(const outputFunction f, Vector<double>& vector) const{
    postOrderHelper(this->root, f, vector);
}
...
template <class T>
void BST<T>::postOrderHelper(const Node<T>* node, const outputFunction f, Vector<double>& vector) const{
    if(node != nullptr){
        postOrderHelper(node->left, f, vector);
        postOrderHelper(node->right, f, vector);
        f(node->data, vector);
    }
}
